...
class CategoryModel {
  ...
  static List <CategoryModel> getCategory(){
    ...
    return [
      ...
      CategoryModel(id: 'politics', name: 'Politics', image: 'assets/images/Politics.png', color: Color(0xFF003E90)),
      ...
      CategoryModel(id: 'environment', name: 'Environment', image: 'assets/images/environment.png', color: Color(0xFF4882CF)),
